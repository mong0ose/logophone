package com.logophone.adapters;
...
public abstract class SampleTableAdapter extends BaseTableAdapter {
	...
	public View getView(int row, int column, View converView, ViewGroup parent) {
        ...
        setBackColor(converView, getCellColor(row));
		return converView;
	}
    ...
    private void setBackColor(View view, int clr) {
        ((TextView) view.findViewById(android.R.id.text1)).setBackgroundColor(clr);
    }
    ...
    public abstract int getCellColor(int row);
